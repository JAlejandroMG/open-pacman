...
- [ ] Durante el modo poder, Pacman puede comer fantasmas por 200 puntos cada uno.
- [ ] Al comer un fantasma con poder, aparece "200" sobre la posición de la colisión.
- [ ] El fantasma comido reaparece en la pen y sale secuencialmente (spec 02).
...
- [ ] Si Pacman choca con un fantasma sin poder activo, pierde una vida (comportamiento actual).
- [ ] Al perder una vida, `powerTimer` se restablece a 0 y `frightened` a `false` en todos los fantasmas.
- [ ] Las power pellets comidas no se restauran al perder una vida (dentro del ciclo).
- [ ] Al perder una vida, los fantasmas vuelven a la pen y salen secuencialmente.
